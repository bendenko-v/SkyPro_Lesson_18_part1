...
# -d '{ "name":"Book 5", "author":"Noname", "year":2002, "pages":777}' \
# -X PUT 127.0.0.1:5000/books/5
#
# curl -X DELETE 127.0.0.1:5000/books/5
#
...
with app.app_context():
    ...
    b2 = Book(id=2, name="Граф Монте-Кристо", author="Александр Дюма", year=1510, pages=1344)
    ...
    db.session.add_all([b1, b2, b3, b4, r1, r2, r3, r4])
    db.session.commit()
